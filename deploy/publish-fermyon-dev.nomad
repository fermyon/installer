...
variable "git_ref" {
  ...
  description = "Git ref to use for the fermyon/installer repo clone. Default: refs/heads/main"
}
...
job "publish-fermyon-dev" {
  ...
  group "publish-fermyon-dev" {
    count = 1

    task "publish-fermyon-dev" {
      driver = "exec"
      ...
      template {
        ...
        readonly repo_dir="${NOMAD_ALLOC_DIR}/installer"
        ...
        rm -rf ${repo_dir}
        git clone -b ${branch} https://github.com/fermyon/installer.git ${repo_dir}
        cd ${repo_dir}/docs
